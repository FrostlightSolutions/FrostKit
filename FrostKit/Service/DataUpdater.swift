...
@objc public protocol DataUpdaterDelegate {
    ...
    - parameter dataUpdater: The data updater that updated data.
    - parameter dataStore:   The data store that got updated.
    */
    ...
    - parameter dataUpdater: The data updater that loaded data.
    - parameter dataStore:   The data store that got loaded.
    */
...
public class DataUpdater: NSObject, DataStoreDelegate {
    ...
    - parameter viewController: The view controller to link to the data updater.
    - parameter tableView:      The table view to link to the data updater.
    */
    ...
    - parameter viewController: The view controller to link to the data updater.
    - parameter tableView:      The collection view to link to the data updater.
    */
...
//        }
    ...
    - parameter count: The count of data objects. By default 0 is passed in.
    */
    ...
    */
    ...
    - parameter tableView: The table view to set.
    */
    ...
    - parameter tableView: The collection view to set.
    */
    ...
    - parameter sectionDictionary: The section dictionary returned from FUS.
    */
    ...
    - parameter viewController: The view controller to add the refresh control to.
    */
    ...
    - parameter indexPath: The index object to return.
    ...
    */
    ...
    - parameter sender: The refresh control that triggered this function.
    */
    ...
    */
    ...
    - parameter json: The JSON to update/load into the data store.
    - parameter page: The page the JSON is related to, or `nil` if the JSON is a non-paged response.
    */
    ...
    */
    private func loadedData() {
        dispatch_async(dispatch_get_main_queue(), { () -> Void in
            if let dataStore = self.dataStore {
                self.updateTableFooter(dataStore.count)
            }
